...
public class Screen1 extends javax.swing.JFrame {
    ...
    public Screen1() {
        ...
        public void actionPerformed(ActionEvent e){
            int finalNum = Integer.parseInt(fldFinalPos.getText()), a=0, b=1, c;
            String result="";
            ...
            lblShowResult.setText(Integer.toString(b));
            JOptionPane.showMessageDialog(btnAccept, result);
        }
        });
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Posicion final");

        jLabel2.setText("Sucesión de Fibonacci");

        jTextField1.setText("posTxtFld");
